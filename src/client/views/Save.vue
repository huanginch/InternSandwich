                      ...
                      <div class="col-lg-4">
                        <p style="font-size: 20px">
                          ...
                          >
                            ...
                            /></svg
                          ><strong>&nbsp;性別：</strong>{{ user_info.gender }}
                        </p>
                        <p style="font-size: 20px">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          >
                            <path
                              d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"
                            /></svg
                          ><strong>&nbsp;生日：</strong>{{ user_info.birth }}
                        </p>
                        <p style="font-size: 20px">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p style="font-size: 20px">
                          ...
                          >
                            <path
                              d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"
                            /></svg
                          ><strong>&nbsp;學校：</strong>{{ user_info.school }}
                        </p>
                        <p style="font-size: 20px">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          >
                            <path
                              d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"
                            /></svg
                          ><strong>&nbsp;電話：</strong>{{ user_info.phone }}
                        </p>
                        <p style="font-size: 20px">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
...
export default {
  ...
  computed: {
    ...
    totalPage: function () {
      return Math.ceil(
        this.saved_posts.length + this.cp_saved_posts.length / this.countOfPage
      );
    },
  },
  methods: {
